...
const defaultSettings = [
  ...
  { 
    ...
    value: 'Leia mangás e novels online gratuitamente', 
    type: 'textarea', 
    category: 'general', 
  ...
  { 
    key: 'site_keywords', 
    value: 'manga, novel, light novel, ler online', 
    type: 'textarea', 
    category: 'general', 
  ...
  { 
    ...
    type: 'boolean', 
    category: 'appearance', 
    description: 'Modo escuro padrão' 
  },
  { 
    key: 'custom_css', 
    value: '', 
  ...
  { 
    key: 'reader_auto_advance', 
    value: 'false', 
    type: 'boolean', 
    category: 'features', 
    description: 'Avançar automaticamente para o próximo capítulo (leitores)'
  },
  { 
  ...
  { 
    ...
    type: 'image', 
    category: 'seo', 
    description: 'Imagem Open Graph padrão' 
  },
  ...
  { 
    key: 'footer_text', 
    value: `© ${new Date().getFullYear()} MN Studio. Todos os direitos reservados.`, 
    type: 'textarea', 
    category: 'footer', 
