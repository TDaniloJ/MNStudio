            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
                <div className="p-4 bg-blue-50 dark:bg-blue-900 rounded-lg text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100">Segurança</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Seus dados protegidos</p>
                </div>
                <div className="p-4 bg-green-50 dark:bg-green-900 rounded-lg text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100">Transparência</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Você controla seus dados</p>
                </div>
                <div className="p-4 bg-purple-50 dark:bg-purple-900 rounded-lg text-center">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100">LGPD</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-300">Conformidade total</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 bg-amber-50 border-l-4 border-amber-500 rounded mb-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">O que são Cookies?</h4>
              ...
              <div className="p-6 bg-primary-50 rounded-lg border-l-4 border-primary-600">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="list-none space-y-2 text-gray-700 dark:text-gray-400">
