  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (isEdit) {
        ...
        const result = await novelService.create(formData); // ✅ DEFINA a variável 'result'
